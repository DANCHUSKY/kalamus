 ...
 * @author daniel
 */
public class InsertVulcania extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public InsertVulcania() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertVulcania.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertVulcania().setVisible(true);
            }
        });
    }
