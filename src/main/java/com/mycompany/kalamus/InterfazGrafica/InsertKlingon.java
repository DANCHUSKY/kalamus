 ...
 * @author daniel
 */
public class InsertKlingon extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public InsertKlingon() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertKlingon.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertKlingon().setVisible(true);
            }
        });
    }
