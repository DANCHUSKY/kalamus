 ...
 * @author daniel
 */
public class InsertAndoria extends javax.swing.JFrame {

    /**
     * Creates new form Menu
     */
    public InsertAndoria() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InsertAndoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new InsertAndoria().setVisible(true);
            }
        });
    }
